...
- (IBAction)go:(UIButton *)sender {
    self.goButton.enabled = NO;
    self.goButton.backgroundColor = UIColor.whiteColor;
    [self.goButton setTitle:@"go" forState:UIControlStateDisabled];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (ret != KERN_SUCCESS) {
            ...
            self.goButton.backgroundColor = UIColor.whiteColor;            [self.goButton setTitle:@"failed, retry" forState:UIControlStateNormal];
